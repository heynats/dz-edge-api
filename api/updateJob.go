...
func UpdateJob(c *gin.Context) {
	...
	case "gal":
		...
		// 	case 0:
		// 		// Call iShopFloor API
		// 		tags := []string{models.Gal01TempAct}
		...
		// 		metrics := services.MetricsFields{
		// 			FurnaceTtemp:     strconv.FormatFloat(val[0], 'f', -1, 64),
		// 			LittleBlueWeight: strconv.FormatFloat(val[1], 'f', -1, 64) + "," + strconv.FormatFloat(val[2], 'f', -1, 64) + "," + strconv.FormatFloat(val[3], 'f', -1, 64) + "," + strconv.FormatFloat(val[4], 'f', -1, 64) + "," + strconv.FormatFloat(val[5], 'f', -1, 64),
		// 			LittleBlueTime:   strconv.FormatFloat(val[6], 'f', -1, 64) + "," + strconv.FormatFloat(val[7], 'f', -1, 64) + "," + strconv.FormatFloat(val[8], 'f', -1, 64) + "," + strconv.FormatFloat(val[9], 'f', -1, 64) + "," + strconv.FormatFloat(val[10], 'f', -1, 64),
		// 			LittleBlueTemp:   strconv.FormatFloat(val[11], 'f', -1, 64) + "," + strconv.FormatFloat(val[12], 'f', -1, 64) + "," + strconv.FormatFloat(val[13], 'f', -1, 64) + "," + strconv.FormatFloat(val[14], 'f', -1, 64) + "," + strconv.FormatFloat(val[15], 'f', -1, 64),
		// 		}
		...
		// 	// case 1:
		// 	// 	// Call iShopFloor API
		// 	// 	tags := []string{models.Gal02TempSet, models.Gal02TempAct}
		...
		// 	// 	metrics := services.MetricsFields{
		// 	// 		SetTemperature:    strconv.FormatFloat(val[0], 'f', -1, 64),
		// 	// 		ActualTemperature: strconv.FormatFloat(val[1], 'f', -1, 64),
		// 	// 		LittleBlueWeight:  strconv.FormatFloat(val[2], 'f', -1, 64) + "," + strconv.FormatFloat(val[3], 'f', -1, 64) + "," + strconv.FormatFloat(val[4], 'f', -1, 64) + "," + strconv.FormatFloat(val[5], 'f', -1, 64) + "," + strconv.FormatFloat(val[6], 'f', -1, 64),
		// 	// 		LittleBlueTime:    strconv.FormatFloat(val[7], 'f', -1, 64) + "," + strconv.FormatFloat(val[8], 'f', -1, 64) + "," + strconv.FormatFloat(val[9], 'f', -1, 64) + "," + strconv.FormatFloat(val[10], 'f', -1, 64) + "," + strconv.FormatFloat(val[11], 'f', -1, 64),
		// 	// 		LittleBlueTemp:    strconv.FormatFloat(val[12], 'f', -1, 64) + "," + strconv.FormatFloat(val[13], 'f', -1, 64) + "," + strconv.FormatFloat(val[14], 'f', -1, 64) + "," + strconv.FormatFloat(val[15], 'f', -1, 64) + "," + strconv.FormatFloat(val[16], 'f', -1, 64),
		// 	// 	}
